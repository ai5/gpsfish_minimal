...
static const Move MOVE_NONE=osl::Move_INVALID;
...
inline bool move_is_special(Move) {
  return false;
}

inline bool move_is_promotion(Move m) {
  return isPromotion(m);
}

inline int move_is_ep(Move) {
  return false;
}

inline int move_is_castle(Move) {
  return false;
}

inline bool move_is_short_castle(Move) {
  return false;
}

inline bool move_is_pawn_drop(Move m){
  return isDrop(m) && ptype(m)==osl::PAWN;
}
inline bool move_is_long_castle(Move) {
  return false;
}
